...
exports.msg_delete = exports.msg_insert = exports.msg_select = void 0;
...
var msg_select = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, Mensajes_1.mensajes.find()];
...
var msg_insert = function (data) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                mensajeModel = new Mensajes_1.mensajes(data);
                return [4 /*yield*/, mensajeModel.save()];
            case 2:
                _a.sent();
                return [3 /*break*/, 6];
            case 3:
...
var msg_delete = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, Mensajes_1.mensajes.deleteMany()];
            case 2:
                _a.sent();
                return [3 /*break*/, 6];
            case 3:
