...
var file = new Archivo_js_1.default(__dirname + "/mensajes.txt");
        ...
        switch (_d.label) {
            ...
            case 1:
                ...
                socket.on("new_message", function (data) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_d) {
                        switch (_d.label) {
                            case 0: return [4 /*yield*/, file.guardar(data)];
                            case 1:
                                _d.sent();
...
router.get("/productos/listar", function (req, res) {
    var result = productos.listar();
    res.json(result.length !== 0 ? result : { error: "No hay productos cargados" });
});
